...
class CPLSystem : public ElectionSystem {
 public:
  ...
  /**
   * @brief Builds party list with a ist of their candidates and
   ...
   * in a piar. To count votes, we read the votes in the file, and assign votes
   * based on Party index in the "partyVotes".
   */
